...
import com.abcd.group1.serviceimpl.EmailService;
import com.abcd.group1.dao.FileDAO;
import com.abcd.group1.model.Error;
		...
		if(validuser==null){
			...
			logger.debug("valid user is available");
			 ...
			 //select * from proj2_profile_pics where username='adam';
		  	...
		  	try{
		  		String path="C:/WORKSPACE-DT5/toygroup1/src/main/webapp/resources/images/users/"+validuser.getUserid()+".jpg";
	...
	public ResponseEntity<?> logout(HttpSession session){
		...
		if(ud!=null){
			...
			try{
				...
				String path="C:/WORKSPACE-DT5/toygroup1/src/main/webapp/resources/images/users/"+ud.getUserid()+".jpg";
				File file=new File(path);
